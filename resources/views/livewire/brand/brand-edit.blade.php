<div class="p-4 md:p-6 max-w-xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 ml-13">Update brand details</p>
    </div>
    ...
    @if ($processing)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl p-6 max-w-xs mx-4 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Updating Brand</h3>
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm text-gray-600">
                        All associated items will be removed.
                    </p>
                </div>
