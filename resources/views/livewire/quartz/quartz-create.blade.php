<div class="p-4 md:p-6 max-w-xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center space-x-3 mb-2">
            ...
            <h1 class="text-2xl font-bold text-gray-800">New Quartz</h1>
        </div>
        <p class="text-gray-600 ml-13">Add a new quartz type</p>
    </div>
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model="name" placeholder="e.g., Rose Quartz, Clear Quartz, Amethyst"
                ...
                @enderror
                <p class="text-xs text-gray-500 mt-1">Choose a unique name for the quartz type</p>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea wire:model="description" rows="4"
                        placeholder="Enter quartz description, properties, characteristics, or usage notes..."
            ...
            <div class="border-t border-gray-200 pt-6">
                <h4 class="text-sm font-medium text-gray-700 mb-3 flex items-center space-x-2">
                    ...
                    <span>About Quartz Types</span>
                </h4>
                <div class="space-y-2">
                    <p class="text-xs text-gray-500 flex items-start space-x-2">
                        <i class="fas fa-check text-green-500 text-xs mt-0.5"></i>
                        <span>Quartz types help categorize and organize related items in the system</span>
                    </p>
                    <p class="text-xs text-gray-500 flex items-start space-x-2">
                        <i class="fas fa-check text-green-500 text-xs mt-0.5"></i>
                        <span>Each quartz type can be assigned to multiple users and bank accounts</span>
                    </p>
                    <p class="text-xs text-gray-500 flex items-start space-x-2">
                        <i class="fas fa-check text-green-500 text-xs mt-0.5"></i>
                        <span>Use descriptive names for better identification and management</span>
                    </p>
                </div>
            </div>
        </form>
    ...
    <div
        ...
        <div class="max-w-xl mx-auto flex items-center justify-end space-x-3">
            ...
            <button type="submit" wire:click="save" wire:loading.attr="disabled"
                ...
                <span wire:loading.remove wire:target="save">Create Quartz</span>
    ...
    @if ($processing)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl p-6 max-w-xs mx-4 text-center">
                <div
                    class="h-16 w-16 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-4 animate-pulse">
                    <i class="fas fa-spinner fa-spin text-white text-xl"></i>
                </div>
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Creating Quartz</h3>
