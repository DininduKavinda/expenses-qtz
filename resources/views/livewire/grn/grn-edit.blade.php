<div class="p-4 md:p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div class="w-full">
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Edit GRN Session</h1>
            <p class="text-sm text-gray-500">Update goods received note</p>
        </div>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <label class="block text-sm font-medium text-gray-700">Split Cost Among (Participants)</label>
                        <span class="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded-full">
                            {{ count($selected_participants) }} selected
                        </span>
                    </div>
                    <div
                        class="p-3 bg-gray-50 rounded-lg border border-gray-200 max-h-48 overflow-y-auto participants-scroll">
                ...
                <!-- Bill Images -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-3">Bill Images</label>

                    @if ($existing_images && count($existing_images) > 0)
                        <!-- Existing Images -->
                        <div class="mb-4">
                            <div class="flex items-center justify-between mb-2">
                                <p class="text-xs font-semibold text-gray-500">Existing Images</p>
                                <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">
                                    {{ count($existing_images) }} images
                                </span>
                            </div>
                    ...
                    @if ($bill_images && count($bill_images) > 0)
                        <!-- New Uploads -->
                        <div class="mb-4">
                            <p class="text-xs font-semibold text-gray-500 mb-2">New Uploads</p>
                            <div class="grid grid-cols-3 gap-2">
                    ...
                    <div
                        ...
                        <label for="file-upload-edit" class="block cursor-pointer">
                            <div class="flex flex-col items-center justify-center space-y-2">
                                <div class="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center">
                                    <i class="fas fa-plus text-blue-600"></i>
                                </div>
                                <div class="text-center">
                                    <span class="text-sm font-medium text-blue-600">Add more images</span>
                                    <p class="text-xs text-gray-500 mt-1">Tap to upload</p>
                                    <p class="text-xs text-gray-400 mt-1">PNG, JPG, GIF up to 10MB</p>
                                </div>
                            </div>
                            <input id="file-upload-edit" wire:model="bill_images" type="file" class="sr-only" multiple>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div
            class="sticky bottom-0 md:static bg-white md:bg-transparent p-3 md:p-0 border-t md:border-0 shadow-lg md:shadow-none">
            <div class="flex flex-col sm:flex-row gap-3">
                <a href="{{ route('grns.index') }}" wire:navigate
                    class="order-2 sm:order-1 w-full px-6 py-3 bg-gray-200 text-gray-700 font-medium rounded-xl hover:bg-gray-300 transition-colors flex items-center justify-center gap-2">
                    <i class="fas fa-times"></i>
                    <span>Cancel</span>
                </a>
                <button type="submit"
                    class="order-1 sm:order-2 w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                    <i class="fas fa-save"></i>
                    <span>Update GRN Session</span>
                </button>
            </div>
        </div>
    </form>
