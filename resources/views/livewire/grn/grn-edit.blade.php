<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit GRN Session</h1>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="mt-1 p-6 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50">
                        <!-- Existing Images -->
                        @if ($existing_images && count($existing_images) > 0)
                            <div class="mb-4">
                                <p class="text-xs font-semibold text-gray-500 mb-2">Existing Images:</p>
                                    ...
                                    @foreach ($existing_images as $img)
                                        <div class="relative group">
                                            ...
                                            <button type="button" wire:click="removeExistingImage({{ $img->id }})"
                                                class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 h-6 w-6 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 justify-center mt-4">
                                <label for="file-upload-edit"
                                    ...
                                    <input id="file-upload-edit" wire:model="bill_images" type="file" class="sr-only"
                                        multiple>
                                </label>
        ...
        <div class="flex justify-end pt-4">
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i> Update GRN Session
            </button>
        </div>
    </form>
</div>