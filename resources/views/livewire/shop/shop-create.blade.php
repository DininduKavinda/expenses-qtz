        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <p class="text-xs text-gray-500">
                    You can add more details like contact information, opening hours, and notes in the edit section
    ...
    @if ($processing)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl p-6 max-w-xs mx-4 text-center">
                <div
                    class="h-16 w-16 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 flex items-center justify-center mx-auto mb-4 animate-pulse">
