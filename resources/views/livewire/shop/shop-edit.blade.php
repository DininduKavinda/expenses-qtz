<div class="p-4 md:p-6 max-w-xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 ml-13">Update shop details</p>
    </div>
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model="name" placeholder="e.g., Main Store, Downtown Branch, Online Shop"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model="location" placeholder="e.g., 123 Main St, City, Country"
        ...
        <div class="max-w-xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button type="submit" wire:click="update" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove wire:target="update">Update Shop</span>
    ...
    @if ($processing)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl p-6 max-w-xs mx-4 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Updating Shop</h3>
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm text-gray-600">
                        All associated price records will be removed permanently.
                    </p>
                </div>
